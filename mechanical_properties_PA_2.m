function KC = mechanical_properties_PA_2(p,R)
...
Ghe1 = 1.27*corr^0.5;% nondim.
Ghe2 = Ghe1;% nondim.
c1 = 28.8341;
c2 = 178.5934;%p/(0.07); %120000;
c4 = 24.5093;%15*133.32/(0.05/20*k+0.1);
...
Ghc = 1.154*corr^.17;% nondim. %HG changed from 1.034. June 22nd
